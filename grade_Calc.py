...
def calculate_statistics(gradebook):
    """
    Calculate individual and overall statistics for the gradebook.
    """
    student_averages = {}
    all_grades = []
...
def visualize_statistics(student_averages):
    """
    Visualize student averages as a bar chart.
    """
...
def show_statistics():
    """
    Show individual and overall statistics in the GUI.
    """
...
def generate_chart():
    """
    Generate a bar chart of student averages.
    """
...
def add_student():
    ...
    """
    Add a new student and their grades to the gradebook.
    """
